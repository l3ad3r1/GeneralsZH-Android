...
// GeneralsX @refactor android-port 08/02/2026 The mobile lifecycle gate and the
// touch gesture translator moved to Core/GameEngineDevice/.../SageMobileInput.cpp
// so the Generals engine gets the identical implementation instead of a copy.
